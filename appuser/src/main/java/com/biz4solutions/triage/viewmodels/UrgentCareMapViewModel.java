package com.biz4solutions.triage.viewmodels;
...
public class UrgentCareMapViewModel extends ViewModel implements OnMapReadyCallback, LocationListener {
...
//                binding.llBookUber.setVisibility(View.VISIBLE);
    ...
    public static class UrgentCareMapFactory extends ViewModelProvider.NewInstanceFactory {
        private final Context context;
        private final UrgentCaresDataResponse urgentCaresDataResponse;

        public UrgentCareMapFactory(Context context, UrgentCaresDataResponse urgentCaresDataResponse) {
            this.context = context;
            this.urgentCaresDataResponse = urgentCaresDataResponse;
        }
        ...
        public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
            return (T) new UrgentCareMapViewModel(context, urgentCaresDataResponse);
        }
    }
